...
<div class="container shadow rounded py-3 px-4">
  <center>
    ...
    <button class="btn btn-success btn-lg btnCrearComiciones"> <i class="fas fa-plus"></i> Crear comiciones</button>
  </center>
  <table id="tblComiciones" class="table table-sm table-hover">
    <thead>
      <th>No</th>
      <th>Tienda</th>
      <th>Puesto</th>
      ...
      <th>Llegada tarde</th>
      <th>Comision nomimal</th>
      <th>Horas Extras</th>
      <th>Valor horas extras</th>
      <th>Día extra o feriado</th>
      <th>Valor días</th>
      <th>Meta</th>
      <th>%</th>
      <th>Premios</th>
